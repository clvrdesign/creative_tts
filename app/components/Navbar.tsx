    ...
    <nav className="sticky top-0 z-50 bg-neutral-900/80 backdrop-blur-sm border-b border-neutral-700/50">
      <Container>
        <div className="relative flex items-center justify-between h-8">
          ...
          {/* Mobile Menu Icon */}
          <div className="md:hidden flex items-center bg-neutral-800 p-2 rounded-xl">
            {isOpen ? (
              <X onClick={() => setIsOpen(false)} className="text-neutral-300 hover:text-white transition-colors duration-200 cursor-pointer" size={24} />
            ) : (
              <Menu onClick={() => setIsOpen(true)} className="text-neutral-300 hover:text-white transition-colors duration-200 cursor-pointer" size={24} />
            )}
          </div>
          ...
          {isOpen && (
            <div className="fixed top-24 left-0 py-4 w-full bg-neutral-900/80 backdrop-blur-sm border-b border-neutral-700/50 flex items-center justify-center sm:space-x-10 space-x-6 border">
              <Link
                href="/"

...
export const TTSInterface = () => {
  ...
  return (
    <div className="max-w-4xl w-full mx-auto md:px-10 md:py-10 space-y-6 md:bg-white md:dark:bg-neutral-900 md:border bg-neutral-950 border-neutral-200 dark:border-neutral-800 border-0 md:rounded-4xl rounded-xl">

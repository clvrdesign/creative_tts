  ...
  return (
    <Container>
      <div className="w-full flex md:flex-row flex-col gap-4 ">
        {/* Main Content Area */}
        <main className="max-w-4xl w-full mx-auto bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 md:px-10 md:py-10 px-6 py-6 space-y-6 md:rounded-4xl rounded-xl">
          {/* Text Input Section */}

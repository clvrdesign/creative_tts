  ...
  return (
    <main className='min-h-screen bg-neutral-950 py-12'>
      <Container>
              ...
              <form className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div>
                  ...
                  <input
                    ...
                    id='name'
                    name='name'
                    className='w-full text-sm outline-none px-4 py-2 border border-neutral-700 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-neutral-800 text-white'
                ...
                <div className='md:col-span-2'>
                  ...
                  <textarea
                    ...
                    name='message'
                    rows={4}
                    className='w-full text-sm outline-none px-4 py-2 border border-neutral-700 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-white bg-neutral-800'
        ...
        {/* FAQ CTA */}
        <section className='text-center py-12 bg-gradient-to-r from-neutral-800 to-neutral-900 rounded-2xl'>
          <h2 className='text-3xl font-bold text-white mb-6'>
            Need Immediate Help?
          </h2>
          <p className='text-sm text-neutral-400 max-w-3xl mx-auto mb-6'>
